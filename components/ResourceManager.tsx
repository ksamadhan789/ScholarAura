  ...
  return (
    <div className="flex flex-col gap-4">
          ...
          {resources.map((r) => (
            ...
            >
              ...
              <button
                ...
                disabled={loading}
                className="shrink-0 rounded-lg border border-slate-300 dark:border-slate-600 px-2 py-1 text-xs text-red-600 disabled:opacity-50 dark:text-red-400"
              >
                Delete
              </button>
            </div>
      ...
      >
        ...
        <div>
          <label className="mb-1.5 block text-sm font-medium text-slate-700 dark:text-slate-200">File (max 4MB)</label>
          <input
            type="file"
            required
