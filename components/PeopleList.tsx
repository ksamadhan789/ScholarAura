        ...
        {people.map((person, index) => (
          <div key={index} className="flex flex-col items-center text-center">
            {person.photoUrl ? (
              ...
              <div className="flex h-20 w-20 items-center justify-center rounded-full bg-gray-200 text-lg font-semibold text-gray-500 shadow-md ring-4 ring-white dark:bg-slate-700 dark:text-slate-400 dark:ring-slate-800">
