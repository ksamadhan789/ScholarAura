    ...
    <div>
      ...
      <div className="flex flex-col gap-3">
        {people.map((person, index) => (
          <div
            key={index}
            className="grid grid-cols-2 gap-2 rounded-lg border border-slate-300 dark:border-slate-600 p-3"
          >
            <input
              type="text"
              ...
              className="col-span-2 rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 px-2 py-1.5 text-sm"
            />
            <input
              type="text"
      ...
      <button
        type="button"
        onClick={addPerson}
        className="mt-2 rounded-lg border border-slate-300 dark:border-slate-600 px-3 py-1.5 text-xs"
      >
        + Add person
      </button>
    </div>
