// ISO 3166-1 alpha-2 code, country name, and E.164 calling code for every
// UN member state (plus a few common territories). Used to build the
// country-code picker on the onboarding form's mobile number field.
export const COUNTRY_CODES: { name: string; iso2: string; dial: string }[] = [
...
// Regional-indicator flag emoji built from the ISO2 code, so we don't have
// to hand-type ~190 flag characters (easy to get wrong / mismatched).
